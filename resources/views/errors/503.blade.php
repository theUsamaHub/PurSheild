...
<title>503 - {{ config('app.name', 'FurShield') }}</title>
...
<div class="err-countdown" id="countdown"></div>
</div>
<script>
var s=30,el=document.getElementById('countdown'),t=setInterval(function(){s--;if(s<=0){clearInterval(t);location.reload();}el.textContent='Page refreshes in '+s+'s';},1000);
</script>
</body>
</html>
