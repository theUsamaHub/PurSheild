...
<title>429 - {{ config('app.name', 'FurShield') }}</title>
...
.err-icon{font-size:40px;color:#f59e0b;margin-bottom:16px;opacity:.85}
...
<div class="err-icon"><i class="bi bi-hourglass-split"></i></div>
<h1 class="err-title">Too Many Requests</h1>
<p class="err-msg">You've made too many requests in a short time. Please wait a moment before trying again.</p>
