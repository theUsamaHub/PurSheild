...
<title>419 - {{ config('app.name', 'FurShield') }}</title>
...
.err-icon{font-size:40px;color:#0ea5e9;margin-bottom:16px;opacity:.85}
...
.err-divider{width:40px;height:3px;background:linear-gradient(90deg,#0ea5e9,#38bdf8);border-radius:2px;margin:0 auto 20px}
</style>
</head>
<body>
<div class="err-card">
...
<p class="err-msg">This page has expired due to inactivity. Your session may have timed out for security reasons. Please try again.</p>
<a href="{{ url('/') }}" class="err-btn"><i class="bi bi-arrow-clockwise"></i> Try Again</a>
<div class="err-links">
<a href="javascript:location.reload()"><i class="bi bi-arrow-repeat"></i> Refresh Page</a>
</div>
</div>
</body>
</html>
