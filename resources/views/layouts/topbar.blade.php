...
<nav class="navbar navbar-expand-lg bg-white border-bottom px-4" style="min-height: 64px;">
    <div class="d-flex align-items-center">
        ...
        <span class="fw-semibold d-none d-lg-block" style="font-size:0.95rem;color:var(--fs-text-heading);">
            @yield('page-title', '')
        </span>
    </div>
    ...
    <div class="ms-auto d-flex align-items-center">
        <!-- Search Button -->
        <button class="btn btn-outline-secondary d-flex align-items-center me-3" style="border-radius:8px;padding:6px 14px;font-size:0.85rem;"
