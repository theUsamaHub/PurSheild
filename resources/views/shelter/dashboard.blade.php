...
<div class="fade-in">
    ...
    @if(Auth::user()->status === 'pending_verification')
        <div class="alert alert-warning d-flex align-items-center" role="alert">
            ...
            <div>
                <strong>{{ __('Pending Verification') }}</strong> - {{ __('Your account is being reviewed by admin. You can edit your profile but cannot create adoption listings until verified.') }}
            </div>
        </div>
    @endif
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <div class="text-muted" style="font-size:0.75rem;">{{ __('Active Listings') }}</div>
            ...
            <div class="card border-0" style="border-left:4px solid var(--fs-info);">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <div class="text-muted" style="font-size:0.75rem;">{{ __('Applications') }}</div>
                            <div class="fw-bold fs-4" style="color:var(--fs-text-heading);">0</div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="empty-state">
                        ...
                        <p>{{ __('No applications received yet.') }}</p>
                    </div>
                </div>
            </div>
        </div>
